...
public class StatCalculator {
    ...
    public HeroStats addAccumulatorArrsToHero(final HeroStats base,
        ...
        final int spd =  (int) (base.spd   + accs0[10]+accs1[10]+accs2[10]+accs3[10]+accs4[10]+accs5[10] + (sets[3] > 3 ? speedSetBonus : 0) + (sets[14] > 3 ? revengeSetBonus : 0)  + (sets[18] > 3 ? reversalSetBonus : 0) + (sets[22] > 3 ? reversalSetBonus : 0) + hero.bonusSpeed + hero.aeiSpeed);
...
//        final float artifactAttack = artifactStats.getAttack();
        ...
        final float bsSpd = (spd - base.spd - (sets[3] > 3 ? speedSetBonus : 0) - (sets[14] > 3 ? revengeSetBonus : 0) - (sets[18] > 3 ? reversalSetBonus : 0) - (sets[22] > 3 ? reversalSetBonus : 0));
